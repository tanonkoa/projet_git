...
/**
 * Job: gitgit Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class gitgit implements TalendJob {
	...
	private final String jobName = "gitgit";
	private final String projectName = "GIT_TEST";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(gitgit.this, new Object[] { e,
					...
					if (sheetList_tFileInputExcel_1.size() > 0) {
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							if (row1 != null) {
								...
								String messagetMsgBox_1 = "check modifs";
	...
	public static void main(String[] args) {
		final gitgit gitgitClass = new gitgit();

		int exitCode = gitgitClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = gitgit.class.getClassLoader()
					.getResourceAsStream(
							"git_test/gitgit_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = gitgit.class.getClassLoader().getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : gitgit");
		}
