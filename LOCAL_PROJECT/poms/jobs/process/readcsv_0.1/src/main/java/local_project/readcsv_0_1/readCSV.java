	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "OrderID", "CustomerID",
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Talend/REP_FORM/SOURCE/Commandes.csv";
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row1.OrderID = fid_tFileInputDelimited_1
							...
							row1.EmployeeID = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.ShipperID = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
						...
						if (row1 != null) {
							...
							if (row1.OrderID != null) { //
								row_tLogRow_1[0] = String.valueOf(row1.OrderID);
							...
							if (row1.EmployeeID != null) { //
								row_tLogRow_1[2] = String
										.valueOf(row1.EmployeeID);

							} //

							if (row1.OrderDate != null) { //
								row_tLogRow_1[3] = FormatterUtils.format_Date(
										row1.OrderDate, "yyyy-MM-dd");

							} //

							if (row1.ShipperID != null) { //
								row_tLogRow_1[4] = String
										.valueOf(row1.ShipperID);
...
/************************************************************************************************
 * 44063 characters generated by Talend Open Studio for Data Integration on the
 * 23 mars 2020 12:09:37 CET
 ************************************************************************************************/
