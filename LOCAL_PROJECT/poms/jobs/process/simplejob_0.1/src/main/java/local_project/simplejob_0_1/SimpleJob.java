...
package local_project.simplejob_0_1;
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SimpleJob.this, new Object[] { e,
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String titletMsgBox_1 = "Simple Job Message";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SimpleJob.class.getClassLoader()
					.getResourceAsStream(
							"local_project/simplejob_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = SimpleJob.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : SimpleJob");
		}
...
/************************************************************************************************
 * 24138 characters generated by Talend Open Studio for Data Integration on the
 * 19 mars 2020 13:56:58 CET
 ************************************************************************************************/
